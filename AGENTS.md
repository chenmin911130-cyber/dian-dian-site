...
- Home rows open in-app guide/article views: study guide covers private/skills school shortlists + application timeline; career guide covers Seek/Trade Me job advice. Guide pages group articles by topic; articles use rich blocks (headings, tables, steps, figures, tips) with clickable official-site buttons.
