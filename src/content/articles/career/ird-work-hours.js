export const irdWorkHours = {
  slug: "ird-work-hours",
  guideId: "career",
  categoryId: "compliance",
  titleZh: "IRD、税号与学生工时：开始工作前先确认",
  titleEn: "IRD, tax numbers and student work hours: confirm before you start",
  excerptZh: "拿到工作 offer 前后，要处理 IRD number、税码、KiwiSaver 选择和学生签证工时。",
  excerptEn: "Before and after a job offer, sort your IRD number, tax code, KiwiSaver choice and student-visa work conditions.",
  ...
  sectionsEn: [
    ...
    },
    {
      ...
      rows: [
        [
          "IRD number",
          "Apply through official Inland Revenue channels and save the number",
          "Used for payroll tax and employer reporting",
        ],
        [
          "Tax code",
          "Complete the tax code form for your study/work situation",
          "Wrong codes can over- or under-deduct tax",
        ],
        [
          "KiwiSaver",
          "Understand auto-enrolment, opt-out and contribution choices",
          "Affects take-home pay and long-term savings",
        ],
        [
          "Employment agreement",
          "Read pay, hours, role, trial terms and breaks before signing",
          "Gives written protection if issues arise",
        ],
        [
          "Payslip",
          "Save every payslip after payday",
          "Lets you check hours, tax, holiday pay and minimum wage",
        ],
      ],
    },
    {
