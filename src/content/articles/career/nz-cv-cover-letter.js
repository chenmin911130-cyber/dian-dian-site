export const nzCvCoverLetter = {
  ...
  excerptZh: "把中国式简历改成本地可读：两页以内、成果导向、针对岗位写第一屏。",
  excerptEn: "Turn a generic resume into a local, readable application: concise, evidence-led and tailored to the role.",
  ...
  sectionsZh: [
    ...
    },
    {
      ...
      rows: [
        [
          "个人简介",
          "本人吃苦耐劳，服从安排",
          "Customer service student with weekend availability and POS experience",
        ],
        [
          "经历描述",
          "负责店铺日常工作",
          "Handled 40+ customer enquiries per shift and balanced till at closing",
        ],
        [
          "技能",
          "熟练使用办公软件",
          "Excel pivot tables, Google Sheets, inventory updates, bilingual Mandarin/English service",
        ],
        [
          "教育",
          "列满高中到大学所有奖项",
          "保留当前 NZ 课程、关键课程项目和与岗位相关的学历",
        ],
      ],
    },
    {
    ...
    },
    {
      ...
      items: [
        ...
        "在 profile 或申请表写清当前签证/工作权利，避免雇主因不确定而直接过滤。",
        "不同岗位换关键词与第一屏顺序，不要一份简历投完全部行业。",
      ],
    },
  ],
  sectionsEn: [
    ...
    },
    {
      ...
      rows: [
        ...
        [
          "Experience",
          "Responsible for daily shop work",
          "Handled 40+ customer enquiries per shift and balanced till at closing",
        ],
        [
          "Skills",
        ...
        [
          "Education",
          "Every award from high school onward",
          "Current NZ programme, relevant projects and qualifications tied to the role",
        ],
      ],
    },
    {
    ...
    },
    {
      ...
      items: [
        ...
        "State your current visa or work rights in the profile or application so employers do not filter you out for uncertainty.",
        "Change keywords and first-screen order by role; do not send one CV to every industry.",
      ],
    },
  ],
};
